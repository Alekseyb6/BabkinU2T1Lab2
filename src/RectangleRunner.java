...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        // print statements for both rectangles, their area's, and their volumes
        System.out.println("Rectanlge 1's Area: " + rect1.calculateArea() + ", Box Volume: " + rect1.calculateBoxVolume(rect1Height));
        System.out.println("Rectanlge 2's Area: " + rect2.calculateArea() + ", Box Volume: " + rect2.calculateBoxVolume(rect2Height));
    }
}
